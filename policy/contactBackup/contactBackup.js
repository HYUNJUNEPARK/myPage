const translations = {
    en: {
        line_h1: "Privacy Policy : Contact Backup",
        line_p1: "'A demain' is the developer and distributor of the Android application 'Contact Backup'.",
        ...
        line_p3: "User data is stored on the device in file format only with the user's consent. The software does not share or transmit any data to the user or others without explicit user permission.",
    ...
    ko: {
        line_h1: "개인 정보 처리 방침 : 연락처 백업",
        line_p1: "'A demain' 은 안드로이드 애플리케이션 '연락처 백업' 의 개발자이자 배포자입니다.",
    
        line_h2: "개인정보 보호",
        line_p2: "본 소프트웨어는 귀하의 개인 정보나 저장된 데이터에 대한 수집, 사용, 공유를 하지 않습니다.",

        line_h3: "사용자 데이터 관리",
        line_p3: "사용자 데이터는 사용자 동의시에만 파일의 형태로 디바이스에서 관리됩니다. 소프트웨어는 사용자의 동의없이 어떤 데이터도 사용자에게 공유, 전송하지 않습니다.",

        line_h4: "면책조항, 책임제한",
        line_p4: "사용자는 소프트웨어가 결함이 있을 수 있고 모든 필요를 충족시키지 못할 수 있다는 점을 인지합니다. 소프트웨어의 설치 및 사용은 사용자의 책임입니다. 사용자는 가능한 데이터 손실에 대한 책임이 있습니다. 본 소프트웨어는 명시적, 묵시적인 보증 없이 '있는 그대로' 제공됩니다. 제작자는 소프트웨어 사용으로 인한 어떠한 손해에 대해서도 책임을 지지 않습니다.",
